      ...
      try {
        const { rows:[r] } = await db.query(`
          INSERT INTO rma (client_id,business_unit_id,ticket_id,product_name,product_code,
            serial_number,defect_description,warranty,unit_cost,responsible_user_id,created_by_user_id)
          ...
          [d.client_id||null,d.business_unit_id||'led',d.ticket_id||null,d.product_name,
           ...
           d.warranty||false,d.unit_cost||null,d.responsible_user_id||user.sub,user.sub]);
