...
async function buildApp() {
  ...
  app.register(async (v1) => {
    ...
    v1.post('/ai/triage', { preHandler: [authenticate] }, async (req, reply) => {
      ...
      const AREAS = ['support','operations','commercial','purchasing','warehouse','fiscal'];
      const AREAS_PT = 'support=Suporte Técnico | operations=Operações/CD | commercial=Comercial | purchasing=Compras | warehouse=CD/Estoque | fiscal=Fiscal';
